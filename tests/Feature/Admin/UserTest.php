...
class UserTest extends TestCase
{
    ...
    public function test_admin_user_can_access_admin_user_index_page()
    {
        ...
        $response = $this->actingAs($admin)->get(route('admin.users.index')); // 管理者ユーザーで会員一覧ページにアクセス
    ...
    public function test_admin_user_can_access_admin_user_show_page()
    {
        ...
        $response = $this->actingAs($admin)->get(route('admin.users.show', $user)); // 管理者ユーザーで会員詳細ページにアクセス
        $response->assertStatus(200); // 200 OK
    }
}
